...
export type SimilarityEvaluator<T, K> = (t: CompleteTransition<T>) => [number, K] | undefined;
 ...
 */
export function matchEntities<T, K = undefined>(
    entitiesA: T[],
    entitiesB: T[],
 ...
 */
function findMatchesDecreasingSimilarity<T, K>(
    entitiesA: T[],
    entitiesB: T[],
    similarityEvaluator: SimilarityEvaluator<T, K>,
