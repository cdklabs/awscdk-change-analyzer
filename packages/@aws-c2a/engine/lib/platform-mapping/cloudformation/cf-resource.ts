...
export class CFResource extends CFEntity {
  ...
  /**
     ...
     */
  private cfUpdateTypeToComponentUpdateType(
    cfUpdateType: string,
    scopeUpdateType?: ComponentUpdateType,
  ){
    ...
    if(scopeUpdateType === ComponentUpdateType.NONE || propertyUpdateType === ComponentUpdateType.NONE)
      return ComponentUpdateType.NONE;
    else if(scopeUpdateType === ComponentUpdateType.POSSIBLE_REPLACEMENT
      || propertyUpdateType === ComponentUpdateType.POSSIBLE_REPLACEMENT)
