import { Component, CompleteTransition, PropertyComponentOperation } from 'cdk-change-analyzer-models';
 ...
 */
export function componentSimilarityEvaluator(
  t: CompleteTransition<Component>,
): [number, PropertyComponentOperation | undefined] | undefined {
...
export function sameNameComponentSimilarityEvaluator(
  t: CompleteTransition<Component>,
): [number, PropertyComponentOperation | undefined] | undefined {
